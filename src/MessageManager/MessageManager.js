...
var AgentManager = require('../AgentManager/agent-manager').manager.AgentManager("host1"),
    ...
    AID = require('../AgentManager/agent-manager').agent.AID,
    Utility = require('../Common/common').util.common,
    ACLPerformatives = require('../AgentManager/agent-manager').fipa.ACLPerformatives;
...
AgentManager.loadAgentClasses(__dirname + '/../../examples', "siebogjs");
